---
title: "Getting Started with ppsrr"
author: "Yubo Shao"
...
output: 
  rmarkdown::html_vignette:
    ...
    mode: selfcontained
vignette: >
  %\VignetteIndexEntry{Getting Started with ppsrr}
...
The `ppsrr` software package is designed to implement the SerBIN method proposed by [Wu et al. (2022)](https://onlinelibrary.wiley.com/doi/full/10.1002/sim.9387), specifically tailored to address the computational challenges inherent in large-scale provider data. Additionally, the package is equipped with functions designed to estimate standardized ratios and rates and conduct hypothesis testing.

In this vignette, we will explore the fundamental usage of the functions integrated into the current R package. 

* For more details, please see the [Reference](https://um-kevinhe.github.io/ppsrr/reference/index.html) section. 

* To learn the algorithms employed by `ppsrr`, refer to the [Models](https://um-kevinhe.github.io/ppsrr/articles/Models.html) section or see the [original articles](https://um-kevinhe.github.io/ppsrr/articles/Articles.html).

* If you need a more concise guide to quickly use the package, please refer to the [Quick Start](https://um-kevinhe.github.io/ppsrr/articles/Quick-start.html).
