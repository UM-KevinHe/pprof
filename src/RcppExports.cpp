...
RcppExport SEXP _ppsrr_logis_fe_prov(SEXP YSEXP, SEXP ZSEXP, SEXP n_provSEXP, SEXP gammaSEXP, SEXP betaSEXP, SEXP backtrackSEXP, SEXP max_iterSEXP, SEXP boundSEXP, SEXP tolSEXP, SEXP messageSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _ppsrr_logis_BIN_fe_prov(SEXP YSEXP, SEXP ZSEXP, SEXP n_provSEXP, SEXP gammaSEXP, SEXP betaSEXP, SEXP parallelSEXP, SEXP threadsSEXP, SEXP tolSEXP, SEXP max_iterSEXP, SEXP boundSEXP, SEXP messageSEXP, SEXP backtrackSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec& >::type Y(YSEXP);
...
RcppExport SEXP _ppsrr_logis_firth_prov(SEXP YSEXP, SEXP ZSEXP, SEXP n_provSEXP, SEXP gammaSEXP, SEXP betaSEXP, SEXP n_obsSEXP, SEXP mSEXP, SEXP parallelSEXP, SEXP threadsSEXP, SEXP tolSEXP, SEXP max_iterSEXP, SEXP boundSEXP, SEXP messageSEXP, SEXP backtrackSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec& >::type Y(YSEXP);
...
RcppExport SEXP _ppsrr_saddlepoint_score(SEXP YSEXP, SEXP ZSEXP, SEXP n_provSEXP, SEXP betaSEXP, SEXP gamma_nullSEXP, SEXP mSEXP, SEXP threadsSEXP, SEXP root_tolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec& >::type Y(YSEXP);
...
// logis_BIN_fe_prov2
List logis_BIN_fe_prov2(arma::vec& Y, arma::mat& Z, arma::vec& n_prov, arma::vec gamma, arma::vec beta, int parallel, int threads, double tol, int max_iter, double bound, bool message, bool backtrack);
RcppExport SEXP _ppsrr_logis_BIN_fe_prov2(SEXP YSEXP, SEXP ZSEXP, SEXP n_provSEXP, SEXP gammaSEXP, SEXP betaSEXP, SEXP parallelSEXP, SEXP threadsSEXP, SEXP tolSEXP, SEXP max_iterSEXP, SEXP boundSEXP, SEXP messageSEXP, SEXP backtrackSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec& >::type Y(YSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type message(messageSEXP);
    Rcpp::traits::input_parameter< bool >::type backtrack(backtrackSEXP);
    rcpp_result_gen = Rcpp::wrap(logis_BIN_fe_prov2(Y, Z, n_prov, gamma, beta, parallel, threads, tol, max_iter, bound, message, backtrack));
    return rcpp_result_gen;
END_RCPP
}
// logis_BIN_fe_prov1
List logis_BIN_fe_prov1(arma::vec& Y, arma::mat& Z, arma::vec& n_prov, arma::vec gamma, arma::vec beta, int parallel, int threads, double tol, int max_iter, double bound, bool message, bool backtrack);
RcppExport SEXP _ppsrr_logis_BIN_fe_prov1(SEXP YSEXP, SEXP ZSEXP, SEXP n_provSEXP, SEXP gammaSEXP, SEXP betaSEXP, SEXP parallelSEXP, SEXP threadsSEXP, SEXP tolSEXP, SEXP max_iterSEXP, SEXP boundSEXP, SEXP messageSEXP, SEXP backtrackSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec& >::type Y(YSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type message(messageSEXP);
    Rcpp::traits::input_parameter< bool >::type backtrack(backtrackSEXP);
    rcpp_result_gen = Rcpp::wrap(logis_BIN_fe_prov1(Y, Z, n_prov, gamma, beta, parallel, threads, tol, max_iter, bound, message, backtrack));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_ppsrr_logis_fe_prov", (DL_FUNC) &_ppsrr_logis_fe_prov, 10},
    {"_ppsrr_logis_BIN_fe_prov", (DL_FUNC) &_ppsrr_logis_BIN_fe_prov, 12},
    {"_ppsrr_logis_firth_prov", (DL_FUNC) &_ppsrr_logis_firth_prov, 14},
    {"_ppsrr_wald_covar", (DL_FUNC) &_ppsrr_wald_covar, 8},
    {"_ppsrr_Modified_score", (DL_FUNC) &_ppsrr_Modified_score, 9},
    {"_ppsrr_saddlepoint_score", (DL_FUNC) &_ppsrr_saddlepoint_score, 8},
    {"_ppsrr_logis_BIN_fe_prov2", (DL_FUNC) &_ppsrr_logis_BIN_fe_prov2, 12},
    {"_ppsrr_logis_BIN_fe_prov1", (DL_FUNC) &_ppsrr_logis_BIN_fe_prov1, 12},
    {NULL, NULL, 0}
};
